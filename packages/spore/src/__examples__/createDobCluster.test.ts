...
import { createClusterCell, dob } from "..";
...
function generateClusterDescriptionUnderDobProtocol(): string {
    ...
    const dob0: dob.Dob0 = {
        ...
        dob: {
            ver: 0,
            decoder: dob.getTestnetDecoder('DOB0', 'code_hash')!,
            pattern: dob0Pattern,
        },
    };
    ...
    const dob1: dob.Dob1 = {
        ...
        dob: {
            ...
            decoders: [
                ...
                {
                    decoder: dob.getTestnetDecoder('DOB1', 'type_script'),
                    pattern: dob1Pattern,
                },
            ],
        },
...
describe("createCluster [testnet]", async () => {
    ...
    it("should create a Cluster cell under DOB protocol", async () => {
        ...
        // Build transaction
        let { transaction: tx, actions, clusterId } = await createClusterCell({
            signer,
            clusterData: {
                name: "Hello, Cluster",
